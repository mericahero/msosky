var MagicZoom_ua = XH.Environment.browser.name;
...
function MagicZoom_addEventListener(obj, event, listener) {
    if (MagicZoom_ua == 'Gecko' || MagicZoom_ua == 'Opera' || MagicZoom_ua == 'Chrome') {
        try {
...
MagicZoom.prototype.replaceZoom = function(e, ael) {
    ...
    newBigImage.src = ael.getElementsByTagName("img")[0].getAttribute("oImg");
...
if (MagicZoom_ua == 'Chrome') try {
    document.execCommand("BackgroundImageCache", false, true)
} catch (e) { };


window.onload = MagicZoom_findZooms;
